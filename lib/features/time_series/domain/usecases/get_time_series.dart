...
class GetTimeSeries implements UseCase<List<StateTimeSeries>, GetTimeSeriesParams> {
  final TimeSeriesRepository repository;

  GetTimeSeries(this.repository);

  @override
  Future<Either<Failure, List<StateTimeSeries>>> call(GetTimeSeriesParams params) async {
