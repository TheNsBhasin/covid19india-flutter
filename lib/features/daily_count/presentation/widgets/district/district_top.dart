...
class _DistrictTopState extends State<DistrictTop> {
  ...
  Widget build(BuildContext context) {
    final List<DistrictDailyCount> districtDailyCount = _getDistrictDailyCount(
        widget.stateDailyCount, widget.statistic,
                          ...
                          children: [
                            ...districtDailyCount
                              ...
                              final int total = getStatistics(districtData,
                                  StatisticType.total, widget.statistic);
                              final int delta = getStatistics(districtData,
                                  StatisticType.delta, widget.statistic);
  ...
  List<DistrictDailyCount> _getDistrictDailyCount(
      StateDailyCount stateDailyCount, Statistic statistic,
      {int count}) {
    List<DistrictDailyCount> sortedList = stateDailyCount.districts
